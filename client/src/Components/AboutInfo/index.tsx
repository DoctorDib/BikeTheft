    ...
    return (
        <section className={classes.container}>
            ...
            <section>
                ...
                <Typography variant="body1"> Simple answer, we do not make any profit from this. This project is completely funded from the money out of our own pockets as well as a few nice donations from you users while running additional ads to help keep the servers on. </Typography>
            </section>

            <section>
                <Typography variant="h5"> Is my data secure? </Typography>
                <Typography variant="body1"> Yes, your data is securely stored on a database. We do not and never will think about selling your data onto third party companies and you are free to request to either view or remove your data from our database. </Typography>
            </section>
