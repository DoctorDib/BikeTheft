        ...
        <section className={classes.container}>
            <section>
                ...
                <Typography variant="body1">
                    {' '}
                    We are a group of 4 developers that have recently graduated
                    with a bachelor&apos;s degree in Software Engineering and
                    Computer Science. Our main goal is to give the public a tool
                    to freely report their own vehicles as stolen or have free
