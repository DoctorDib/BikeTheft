...
export const FormatPostBackground = (styleID: number) => {
    switch (styleID) {
        case 1: return 'white';
...
export const FormatAvatar = (comment: IComment, classes:any) => {
    ...
    return (
        <section className={classes.postContainer}>
            <section className={classes.avatarContainer}>
                <Avatar alt="Remy Sharp" src={image} className={classes.profileImage} style={{backgroundColor: avatarColour}}>
                    {image}
                </Avatar>
